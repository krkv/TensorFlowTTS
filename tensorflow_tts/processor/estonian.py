...
"""Perform preprocessing and raw feature extraction for Estonian dataset."""
...
_punctuation = "!'(),.? "
_special = "-"
_letters = "ABCDEFGHIJKLMNOPQRSTUVWXYZÕÄÖÜabcdefghijklmnopqrstuvwxyzõäöü"
...
@dataclass
class EstonianProcessor(BaseProcessor):
    """Estonian processor."""

    cleaner_names: str = "transliteration_cleaners"
    positions = {
        "wave_file": 0,
        "text_norm": 1,
    }
